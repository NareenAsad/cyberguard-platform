...
export default function DataSourcesTab() {
    ...
    const colorsMap: Record<string, string> = {
        blue: 'border-blue-500/40 bg-blue-600/8', emerald: 'border-emerald-500/40 bg-emerald-600/8',
                            ...
                            <div key={src.key} className={`rounded-2xl border bg-slate-900/60 p-5 space-y-4 transition-all ${
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button onClick={() => save(src.key, { enabled: !src.enabled })}
                                        ...
                                        className={`relative w-11 h-6 rounded-full transition-all duration-300 ${src.enabled ? 'bg-blue-500' : 'bg-slate-700'}`}>
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full pr-10 px-3 py-2 rounded-xl bg-slate-800/60 border border-slate-700/60 text-slate-200 text-sm placeholder:text-slate-600 focus:outline-none focus:border-blue-500/60 transition-all"
                                        />
                                        <button type="button"
